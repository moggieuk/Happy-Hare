    ...
    def _do_form_tip(self, test=False):
        with self._wrap_extruder_current(self.extruder_form_tip_current, "for tip forming move"):
            ...
            try:
                ...
                self._wrap_gcode_command("%s MACRO=%s VARIABLE=%s VALUE=%.1f" % ("SET_GCODE_VARIABLE", self.form_tip_macro, "toolhead_ooze_reduction", self.toolhead_ooze_reduction), exception=True)
