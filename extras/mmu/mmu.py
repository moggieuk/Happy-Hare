...
class Mmu:
    ...
    SENSOR_SELECTOR_TOUCH      = "mmu_sel_touch"  # For LinearSelector, LinearIdlerSelector and LinearServoSelector
    SENSOR_SELECTOR_HOME       = "mmu_sel_home"   # For LinearSelector, LinearIdlerSelector and LinearServoSelector
