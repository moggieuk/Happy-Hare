...
class MmuLedCommand(LedMixin, BaseCommand):
    ...
    HELP_PARAMS = (
        ...
        + "EXIT_EFFECT   = [off|gate_status|filament_color|td1_color|slicer_color|r,g,b|_effect_]\n"
        + "ENTRY_EFFECT  = [off|gate_status|filament_color|td1_color|slicer_color|r,g,b|_effect_]\n"
        + "STATUS_EFFECT = [off|on|filament_color|td1_color|slicer_color|r,g,b|_effect_]\n"
