...
class MmuServer:
    ...
    def __init__(self, config):
        ...
        # Switch out the metadata processor with enhanced one that handles placeholders
        file_manager.METADATA_SCRIPT = file_manager.METADATA_SCRIPT.replace("metadata.py", "mmu_metadata.py")
