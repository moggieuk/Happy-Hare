...
purge_on_load: 0                        # 1 = automatically purge after load/toolchange, 0 = never auto purge on load (this only works during print and ovberrides the purge macro)
...
purge_transition_speed: 2.0	# mm/s extrusion speed for the purge-on-load temperature transition
