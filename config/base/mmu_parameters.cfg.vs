...
#                    Fast bowden load will move to extruder_entry_load_buffer distance before extruder gear
#   extruder       - If you have a "filament entry" endstop configured (Requires 'extruder' endstop)
#                    Fast bowden load will move to extruder_entry_load_buffer distance before sensor
...
extruder_load_buffer: 30		# Amount to reduce the fast bowden load so filament doesn't overshoot the extruder homing point
