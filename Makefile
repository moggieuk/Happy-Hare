...
hh_klipper_extras_files := $(wildcard extras/*.py extras/mmu/*.py extras/mmu/unit/*.py extras/mmu/unit/nfc/*.py extras/mmu/unit/td1/*.py extras/mmu/unit/selectors/*.py extras/mmu/commands/*.py)
